...
namespace ltm {
    namespace db {
        ...
        void EpisodeCollectionManager::make_meta_episode(const Episode &node, MetadataPtr meta) {
        ...
        void EpisodeCollectionManager::make_meta_when(const When &node, MetadataPtr meta) {
        ...
        void EpisodeCollectionManager::make_meta_relevance_historical(const HistoricalRelevance &node, MetadataPtr meta) {
        ...
        std::string EpisodeCollectionManager::vector_to_str(const std::vector<std::string> &array) {
        ...
        void EpisodeCollectionManager::vector_merge(std::vector<std::string> &result, const std::vector<std::string> &source) {
            std::vector<std::string>::const_iterator it;
        ...
        bool EpisodeCollectionManager::update_tree_tags(Episode &node, const Episode &child) {
        ...
        void EpisodeCollectionManager::update_tree_info_init(Info &node) {
            node.n_usages = 0;
        ...
        void EpisodeCollectionManager::update_tree_relevance_init(Relevance &node) {
            update_tree_relevance_historical_init(node.historical);
            update_tree_relevance_emotional_init(node.emotional);
        }

        bool EpisodeCollectionManager::update_tree_relevance(Relevance &node, const Relevance &child, bool is_leaf) {
            bool result = true;
        ...
        void EpisodeCollectionManager::update_tree_relevance_historical_init(HistoricalRelevance &node) {
            node.value = 0;
        }

        bool EpisodeCollectionManager::update_tree_relevance_historical(HistoricalRelevance &node, const HistoricalRelevance &child) {
        ...
        void EpisodeCollectionManager::update_tree_relevance_emotional_init(EmotionalRelevance &node) {
